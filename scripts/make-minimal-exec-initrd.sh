...
sources=(agent true false writeout sleeper finite counter nproc gencheck netcheck nslookup wget httpd flockcheck cgroupcheck)
...
chmod 0755 "${workdir}/root/init" "${workdir}/root/bin/true" "${workdir}/root/bin/false" "${workdir}/root/bin/writeout" "${workdir}/root/bin/sleeper" "${workdir}/root/bin/finite" "${workdir}/root/bin/counter" "${workdir}/root/bin/nproc" "${workdir}/root/bin/gencheck" "${workdir}/root/bin/netcheck" "${workdir}/root/bin/nslookup" "${workdir}/root/bin/wget" "${workdir}/root/bin/httpd" "${workdir}/root/bin/flockcheck" "${workdir}/root/bin/cgroupcheck"
