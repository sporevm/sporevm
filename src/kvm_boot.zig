...
//!   zig build kvm-boot
//!   ./zig-out/bin/kvm-boot <kernel-Image> [--cmdline "..."] [--mem-mib N] [--disk rootfs.ext4] [--snapshot-after-ms N --spore DIR] [--resume DIR]
...
pub fn main(init: std.process.Init) !void {
    ...
    if (args.len < 2) {
        std.debug.print("usage: kvm-boot <kernel-Image> [--cmdline \"...\"] [--mem-mib N] [--disk rootfs.ext4] [--snapshot-after-ms N --spore DIR] [--resume DIR]\n", .{});
        std.process.exit(2);
    }
