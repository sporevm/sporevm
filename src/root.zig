...
pub const board = @import("aarch64/board.zig");
...
pub const gicv3 = @import("aarch64/gicv3.zig");
pub const fdt = @import("aarch64/fdt.zig");
...
pub const image_gateway_pull = @import("image_gateway_pull.zig");
...
test {
    ...
    testing.refAllDecls(image_gateway_pull);
