...
pub const image_gateway_manifest = @import("image_gateway_manifest.zig");
...
pub const runtime_disk_claim = @import("runtime_disk_claim.zig");
pub const runtime_disk_fork = @import("runtime_disk_fork.zig");
...
test {
    ...
    testing.refAllDecls(image_gateway_manifest);
    ...
    testing.refAllDecls(runtime_disk_claim);
    testing.refAllDecls(runtime_disk_fork);
